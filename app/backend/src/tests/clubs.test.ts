...
describe('testa o endpoint /teams', () => {
  describe('caso o endpoint /teams com o metodo getClubs', async () => {
    describe('retorna com sucesso', async () => {
      ...
      it('um array que possui id e name', async () => {
        chaiHttpResponse = await chai
        .request(app)
        .get('/teams')
        .send(clubs)
...
describe('testando o endpoint /teams/:id', () => {
  describe('com a rota /teams/:id com o metodo getById', async () => {
