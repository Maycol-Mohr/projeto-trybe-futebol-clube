...
import leaderboarderHomeMock from './mocks/leaderboarderhome.mock';
import { app } from '../app';
...
describe('testa o endpoint /leaderboard/home', () => {
  describe('caso o endpoint /home com o metodo getHomeClassification', async () => {
