...
import leaderboardertotalMock from './mocks/leaderboardtotal.mock';
import { app } from '../app';
...
describe('testa o endpoint /leaderboard', () => {
  describe('caso o endpoint /leaderboard com o metodo getTotalClassification', async () => {
